    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
        <div className="flex flex-col items-center justify-center py-24 text-sm text-muted-foreground">
          ...
          <Button variant="outline" onClick={() => router.visit('/purchases/returns')}>Back to Purchase Returns</Button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between">
        <button onClick={() => router.visit('/purchases/returns')} className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          {originalBill && (
            <Link href={`/purchases/${returnData.originalPurchaseId}`}
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {originalBill && (
            <div className="mt-1">
              <Link href={`/purchases/${returnData.originalPurchaseId}`} className="text-xs text-primary hover:underline inline-flex items-center gap-1">
