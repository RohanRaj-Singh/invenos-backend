...
import { t as ImageViewer } from "./ImageViewer-B1_yMPbZ.js";
...
import { Dt as router3, Ot as usePage, Tt as toast, _t as Package, dt as ShoppingCart, lt as Trash2, rt as formatCurrency } from "./app-DxiW8KTt.js";
...
function VisitDetailPage() {
	...
	const handleRestore = () => {
		router3.post(`/clinic/consultations/${c.id}/restore`, {}, {
			onSuccess: () => {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [c.deleted_at ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "size-5" }), "Delete Consultation"]
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogDescription, {
								...
								children: [
									...
									" the consultation and all linked prescriptions. The associated sale invoice ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: sale.invoice_number || c.id }),
									" will also be deleted via the lifecycle system, which will:"
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
								className: "text-xs text-muted-foreground space-y-1.5 list-disc pl-4",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Add inventory back to stock" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Reverse the customer balance impact" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Record an audit log entry" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Move the records to the Recycle Bin" })
								]
							}),
