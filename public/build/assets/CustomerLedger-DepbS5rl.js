...
import { Ot as usePage, ct as Users, it as formatDate, rt as formatCurrency } from "./app-DRCb4nuk.js";
import { t as ReportLayout } from "./ReportLayout-647vA4sZ.js";
import { t as ReportTable } from "./ReportTable-C8gtD7kL.js";
//#region resources/js/Pages/reports/CustomerLedger.tsx
...
function CustomerLedgerPage() {
	...
	const openingBalance = rows.length > 0 ? 0 : 0;
			...
			render: (r) => {
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-semibold ${{
						...
						"Payment": "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30"
	...
	if (!contact) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReportLayout, {
		...
		subtitle: "Select a customer to view their financial statement",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "size-12 mx-auto mb-3 text-muted-foreground/20" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "No customer selected. Navigate from a customer profile or use the contact filter." })]
		})
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ReportLayout, {
		title: contact.name,
		subtitle: `Phone: ${contact.phone || "—"} · Customer Ledger — All financial activity`,
		icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "size-5 text-primary" }),
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [formatCurrency(Math.abs(closingBalance)), closingBalance > 0 ? " (Receivable)" : closingBalance < 0 ? " (Credit)" : ""]
					})]
				})
			]
			...
			emptyMessage: "No transactions found for this customer in the selected period."
		})]
	});
}
//#endregion
export { CustomerLedgerPage as default };
