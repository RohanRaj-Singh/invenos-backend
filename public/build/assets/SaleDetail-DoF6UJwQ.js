...
import { At as usePage, Dt as toast, Ot as Link_default, _t as Receipt, dt as Trash2, kt as router3, st as formatCurrency } from "./app-BJCY_l2M.js";
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						usePermission("sales", "delete") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "outline",
							size: "sm",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
					...
					children: "This will reverse inventory, adjust customer balance, and move the invoice to the Recycle Bin. This action can be undone by restoring from the Recycle Bin."
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							onClick: () => {
								...
								router3.delete(`/sales/${sale.id}`, {
									...
									onError: (errs) => {
										...
										toast.error(String(first || "Failed to delete sale"));
										setDeleting(false);
										setShowDeleteDialog(false);
									},
									onFinish: () => {
