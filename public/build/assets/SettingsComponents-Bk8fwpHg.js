...
import { Dt as usePage, Et as router3 } from "./app-fzdHvqQg.js";
//#region resources/js/Pages/components/SettingsComponents.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "hidden md:flex flex-col w-48 shrink-0 border-r border-border p-3 space-y-0.5",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "md:hidden overflow-x-auto border-b border-border",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex gap-1 px-4 py-2",
					children: SETTINGS_SECTIONS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: () => router3.visit(s.href),
						className: cn("whitespace-nowrap px-3 py-1.5 rounded-lg text-xs font-medium transition-colors", url === s.href ? "bg-foreground text-background" : "text-muted-foreground hover:text-foreground border border-border"),
						children: s.label
					}, s.id))
				})
			}),
