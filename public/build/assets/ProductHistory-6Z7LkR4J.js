...
import { t as ReportToolbar } from "./ReportToolbar-jzSDEkxR.js";
...
import { Ot as usePage, _t as Package, it as formatDate, rt as formatCurrency } from "./app-DRCb4nuk.js";
import { t as ReportLayout } from "./ReportLayout-647vA4sZ.js";
import { t as SummaryCards } from "./SummaryCards-B3E8oE7M.js";
import { t as ReportTable } from "./ReportTable-C8gtD7kL.js";
//#region resources/js/Pages/reports/ProductHistory.tsx
...
function ProductHistoryPage() {
	...
	const cards = (0, import_react.useMemo)(() => [
		...
		},
		{
			...
			value: (summary.total_purchase_returned || 0).toLocaleString(),
			negative: true
		}
	], [summary]);
	const columns = [
	...
	if (!product) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReportLayout, {
		...
		subtitle: "Select a product to view its inventory timeline",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Package, { className: "size-12 mx-auto mb-3 text-muted-foreground/20" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "No product selected. Use the product filter above or navigate from a product detail page." })]
		})
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ReportLayout, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-4 flex-wrap text-xs text-muted-foreground",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Opening →" }),
						...
						summary.total_purchase_returned > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "flex items-center gap-1 text-red-500 font-medium",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrendingDown, { className: "size-3" }),
								" -",
								summary.total_purchase_returned,
								" Purch Returns"
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						summary.total_sale_returned > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "flex items-center gap-1 text-amber-600 font-medium",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrendingUp, { className: "size-3" }),
								" +",
								summary.total_sale_returned,
								" Sale Returns"
							]
						}),
						summary.total_adjusted !== 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
//#endregion
export { ProductHistoryPage as default };
