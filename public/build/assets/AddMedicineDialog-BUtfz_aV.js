...
import { _t as Package, gt as Plus, mt as Search, ot as X, rt as formatCurrency } from "./app-DQEL3DJY.js";
import { t as Badge } from "./badge-BfSUOZdI.js";
import { n as formatWithUnit, r as resolveUnitDisplay } from "./product-unit-display-D3DaRJfT.js";
//#region resources/js/lib/measurement-options.ts
...
*/
function getMeasurementOptions(baseUnitId) {
	...
	if (type === "weight") {
		...
		if (gFactor !== null) opts.push({
			id: "__custom_gram",
			label: "Gram (g)",
			factor: gFactor
		});
		const kgFactor = convert(1, "kg", baseUnitId);
		if (kgFactor !== null) opts.push({
			id: "__custom_kg",
			label: "Kilogram (kg)",
			factor: kgFactor
		});
	...
	if (type === "volume") {
		...
		if (mlFactor !== null) opts.push({
			id: "__custom_ml",
			label: "Millilitre (ml)",
			factor: mlFactor
		});
		const lFactor = convert(1, "liter", baseUnitId);
		if (lFactor !== null) opts.push({
			id: "__custom_liter",
			label: "Litre (L)",
			factor: lFactor
		});
	...
	if (type === "length") {
		...
		if (cmFactor !== null) opts.push({
			id: "__custom_cm",
			label: "Per cm",
			factor: cmFactor
		});
		const mFactor = convert(1, "meter", baseUnitId);
		if (mFactor !== null) opts.push({
			id: "__custom_meter",
			label: "Per Meter",
			factor: mFactor
		});
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
									...
									onChange: (e) => {
										...
										if (val.startsWith("__custom_")) {
											const opt = getMeasurementOptions(product.base_unit_id).find((o) => o.id === val);
											if (!opt) return;
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [
												...
												" = ",
												formatWithUnit(working.baseQuantity, resolveUnitDisplay(working.product.base_unit_id))
											]
										})
									]
								}),
